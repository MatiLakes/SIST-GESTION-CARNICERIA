  ...
  return (
    <div className={styles["categoria-container"]}>
      ...
      >
        ...
        <p>¿Estás seguro de que deseas eliminar esta merma?</p>
        {mermaToDelete && (
          <div style={{ margin: '20px 0', padding: '10px', backgroundColor: '#f8f9fa', borderRadius: '5px' }}>
            <p><strong>Tipo:</strong> {mermaToDelete.tipoProductoMerma}</p>
            <p><strong>Cantidad Perdida:</strong> {mermaToDelete.cantidadPerdida}</p>
            <p><strong>Causa:</strong> {mermaToDelete.causa}</p>
            <p><strong>Personal:</strong> {mermaToDelete.personal?.nombre || 'No asignado'}</p>
          </div>
        )}
