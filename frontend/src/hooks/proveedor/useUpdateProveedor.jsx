import { updateProveedor } from '@services/proveedor.service'; // Asegúrate de que el servicio esté correctamente importado
import { showErrorAlert, showSuccessAlert } from '@helpers/sweetAlert';

const useUpdateProveedor = (fetchProveedores) => {
    const handleUpdate = async (id, proveedorData) => {
        try {
            await updateProveedor(id, proveedorData); // Actualiza el proveedor
